...
coverage: ## check code coverage quickly with the default Python
	coverage run --source playbook_documenter -m pytest
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/playbook_documenter.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ playbook_documenter
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
upstream: ## set the upstream for the repository
	git remote set-upstream https://gitlab.com/fhightower-tc/playbook_documenter.git
